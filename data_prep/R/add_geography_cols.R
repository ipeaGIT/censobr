...
# Add basic geography variables to census tracts
#' @keywords internal
add_geography_cols_tracts <- function(arrw, year){
  ...
  # reoder columns
  arrw <- relocate(arrw, c(code_tract, code_muni, code_state, abbrev_state, name_state, code_region, name_region))
