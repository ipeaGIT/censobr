...
The **censobr** package includes a few functions to help users navigate Brazilian census data, its variables and methodology. All of these functions download supporting documents in either `.html` or `.pdf` format, and open the documents on a web browser.
