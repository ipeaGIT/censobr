...
Since we don't need to load to memory all columns from the data, we can pass a vector the the columns we're going to use. This might be necessary in more constrained computing environments.
