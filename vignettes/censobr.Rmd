...
By default, **{censobr}** files are saved in the 'User' directory. However, users can run the function `set_censobr_cache_dir()` to set custom cache directory. This directory lives across R sessions.
...
If you do not remember the location of the cache, you can always run `get_censobr_cache_dir()` to return the path of the cache directory in use.
