...
```
```{r figure 1, eval=FALSE, echo=FALSE, message=FALSE, out.width='100%'}
knitr::include_graphics("https://github.com/ipeaGIT/censobr/blob/main/inst/img/vig_output_pop1.png?raw=true")
```
